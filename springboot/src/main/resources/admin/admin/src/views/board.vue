<template>
<div class="content box9" :style='{"alignContent":"flex-start","minHeight":"100vh","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230327/ec9b479a2028469a9e6aa7e2742bb91e.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"auto"}'>
	<!-- 标题 -->
	<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230327/4c4a3fe6e90e49baa7f646298e7932cb.gif) no-repeat center top / 100% 100%","width":"100%","lineHeight":"76px","fontSize":"22px","height":"70px"}'>欢迎使用 {{this.$project.projectName}}</div>
	<!-- 时间 -->
	<div :style='{"top":"0","color":"#fff","display":"inline-block","lineHeight":"50px","fontSize":"16px","position":"absolute","right":"3%","height":"64px"}' class="times">{{ dates }}</div>
	<!-- 系统简介 -->
	<div v-if="systemIntroductionDetail" :style='{"padding":"0.3%","margin":"0 1% 30px 3%","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230327/9439908e0efe4c2d8610f4d981d6c894.gif) no-repeat center top / 100% 100%","display":"flex","width":"30%","height":"250px"}'>
		...
		<div :style='{"padding":"1%","margin":"0 0 0 10px","overflow":"hidden","color":"#fff","flex":1,"lineHeight":"1.5","fontSize":"14px","textIndent":"2em","height":"95%"}' v-html="systemIntroductionDetail.content"></div>
	</div>
	<!-- 统计 -->
	<div :style='{"alignContent":"flex-start","padding":"0.3%","margin":"0 1% 30px 1%","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230327/9439908e0efe4c2d8610f4d981d6c894.gif) no-repeat center top / 100% 100%","display":"flex","width":"30%","height":"250px"}'>
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, shujufenxiChart3)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, shujufenxiChart4)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, shujufenxiChart5)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, shujufenxiChart8)
...
<style lang="scss" scoped>
	...
	.box9 .tables {
				...
				margin: 0 3% 0px 1%;
				overflow: hidden;
				background: url(http://codegen.caihongy.cn/20230327/9439908e0efe4c2d8610f4d981d6c894.gif) no-repeat center top / 100% 100%;
				width: 46%;
				transition: 0.3s;
				height: 360px;
				order: 33;
