<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"176px 0 60px","listStyle":"none","margin":"0","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20221203/15df4ce8a9374543a0e5ee5393514725.png) no-repeat center top","flexDirection":"column","display":"flex","width":"100%","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","padding":"0","margin":"0 0px","borderRadius":"0px","background":"rgba(255,255,255,.6)","display":"none","width":"100%"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #333;
				  				  white-space: nowrap;
				  				  background: url(http://codegen.caihongy.cn/20221203/5a879e955f0b44a4b858d352e40effd0.png) no-repeat,#fff;
				  				  line-height: 53px;
				  				  position: relative;
				  		}
