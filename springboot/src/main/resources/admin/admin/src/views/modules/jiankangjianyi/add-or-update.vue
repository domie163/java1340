	...
	<div class="addEdit-block" :style='{"padding":"30px","alignItems":"flex-start","flexWrap":"wrap","justifyContent":"flex-start","display":"flex"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="健康分析" prop="jiankangfenxi">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jiankangfenxi" label="健康分析" prop="jiankangfenxi">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="健康建议" prop="jiankangjianyi">
					<editor 
						style="min-width: 200px; max-width: 600px;"
